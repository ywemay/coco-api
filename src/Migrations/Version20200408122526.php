 ...
 */
final class Version20200408122526 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE physical_address (id INT AUTO_INCREMENT NOT NULL, customer_profile_id INT DEFAULT NULL, province VARCHAR(15) NOT NULL, city VARCHAR(30) NOT NULL, street VARCHAR(150) NOT NULL, address VARCHAR(150) NOT NULL, lt DOUBLE PRECISION DEFAULT NULL, lg DOUBLE PRECISION DEFAULT NULL, locked TINYINT(1) NOT NULL, INDEX IDX_19F6C7AC3133163A (customer_profile_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sale_order (id INT AUTO_INCREMENT NOT NULL, assigned_to_id INT DEFAULT NULL, container_load_report_id INT DEFAULT NULL, address_id INT NOT NULL, customer_id INT NOT NULL, date DATE NOT NULL, state SMALLINT NOT NULL, container_type VARCHAR(6) NOT NULL, start_date_time DATETIME NOT NULL, price INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_25F5CB1BF4BD7827 (assigned_to_id), UNIQUE INDEX UNIQ_25F5CB1BDCEEBF30 (container_load_report_id), INDEX IDX_25F5CB1BF5B7AF75 (address_id), INDEX IDX_25F5CB1B9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE customer_profile (id INT AUTO_INCREMENT NOT NULL, company VARCHAR(100) NOT NULL, phones LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', emails LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', webpage VARCHAR(150) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sale_order ADD CONSTRAINT FK_25F5CB1B9395C3F3 FOREIGN KEY (customer_id) REFERENCES customer_profile (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE physical_address DROP FOREIGN KEY FK_19F6C7AC3133163A');
        $this->addSql('ALTER TABLE sale_order DROP FOREIGN KEY FK_25F5CB1B9395C3F3');
