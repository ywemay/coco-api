 ...
 */
final class Version20200314151720 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, name VARCHAR(150) NOT NULL, UNIQUE INDEX UNIQ_4FBF094F7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE container_load_order (id INT AUTO_INCREMENT NOT NULL, sale_order_id INT NOT NULL, assigned_to_id INT DEFAULT NULL, created_at DATETIME NOT NULL, amount_due INT NOT NULL, state SMALLINT NOT NULL, UNIQUE INDEX UNIQ_7F936EC593EB8192 (sale_order_id), INDEX IDX_7F936EC5F4BD7827 (assigned_to_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
